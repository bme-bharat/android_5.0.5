...
import { CountryCodes, GenderType, ProfileSelect, stateCityData } from '../../assets/Constants';
...
const UserProfileUpdateScreen = () => {
  ...
  }, [postData, profile, isImageChanged, verifiedEmail]);
  ...
  const genderList = GenderType.map(item => ({
    label: item.label,
    value: item.label,
  }));
  ...
  const stateList = Object.keys(stateCityData).map(state => ({
    label: state,
    value: state,
  }));
  ...
  const [selectedType, setSelectedType] = useState(profile.select_your_profile || "");
  const [selectedCategory, setSelectedCategory] = useState(profile.category || "");

  const normalProfiles = ProfileSelect.normalProfiles;

  // First dropdown: profile types
  const typeList = Object.keys(normalProfiles).map(type => ({
    label: type,
    value: type,
  }));

  // Second dropdown: categories (depends on selected type)
  const categoryList = selectedType
    ? normalProfiles[selectedType].map(category => ({
      label: category,
      value: category,
    }))
    : [];
  ...
  const handlePostSubmission = async () => {
    ...
    try {
      ...
      const postPayload = {
        ...
        select_your_profile: selectedType,
      ...
      <View style={styles.container} >
        ...
        >
          ...
          <View style={styles.inputContainer}>
            ...
            <Dropdown
              ...
              onChange={item => {
                ...
                setPostData(prev => ({ ...prev, select_your_profile: item.value, category: "" }));
              }}
          ...
          <View style={styles.inputContainer}>
            ...
            <Dropdown
              style={[styles.dropdown, !selectedType && styles.disabledDropdown]}
              data={categoryList}
              labelField="label"
              valueField="value"
              placeholder={
                selectedType ? 'Select Profile Category' : 'Select a type first'
              }
              value={selectedCategory}
              onChange={item => {
                setSelectedCategory(item.value);
                setPostData(prev => ({ ...prev, category: item.value }));
              }}
          ...
          <View style={styles.inputContainer}>
            ...
            <Dropdown
              ...
              onChange={item => {
                ...
                setPostData(prev => ({ ...prev, gender: item.value }));
              }}
          ...
          <View style={[styles.inputContainer, {}]}>
            ...
            <Dropdown
              ...
              onChange={item => {
                ...
                setPostData(prev => ({ ...prev, state: item.value, city: "" }));
              }}
          ...
          <View style={[styles.inputContainer, {}]}>
            ...
            <Dropdown
              ...
              onChange={item => {
                ...
                setPostData(prev => ({ ...prev, city: item.value }));
              }}
              placeholderStyle={styles.placeholder}
              selectedTextStyle={styles.selectedText}
              search
